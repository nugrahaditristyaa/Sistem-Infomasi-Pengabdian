                        ...
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">
                                    KPI IKT.I.5.i - HKI Pengabdian per Prodi
                                    @if ($filterYear !== 'all')
                                        <small class="text-lowercase">(Tahun {{ $filterYear }})</small>
                                    @endif
                                    <i class="fas fa-info-circle ml-1 tooltip-icon" data-toggle="tooltip"
                                        title="Target: Minimal 1 HKI per prodi per tahun" style="cursor: pointer;"></i>
                                </div>
                                @php
                                    // Hitung HKI per prodi
                                    use Illuminate\Support\Facades\DB;

                                    // Query base untuk HKI
                                ...
                                <div class="h5 mb-2 font-weight-bold text-gray-800">
                                    Total HKI: {{ $totalHki }}
                                    @if ($keduaProdiTercapai)
                                        <span class="badge badge-success ml-2">Target Tercapai</span>
                                    @else
                                        <span class="badge badge-warning ml-2">Belum Tercapai</span>
                                    @endif
                                </div>
                                ...
                                <div class="row mb-2">
                                    <div class="col-md-6">
                                        <div class="text-sm">
                                            <i class="fas fa-laptop-code text-primary mr-1"></i>
                                            <strong>Informatika:</strong> {{ $hkiInformatika }} HKI
                                            @if ($informatikaTercapai)
                                                <span class="badge badge-success badge-sm ml-1">✓</span>
                                            @else
                                                <span class="badge badge-danger badge-sm ml-1">✗</span>
                                            @endif
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="text-sm">
                                            ...
                                            <strong>Sistem Informasi:</strong> {{ $hkiSistemInformasi }} HKI
                                            @if ($sistemInformasiTercapai)
                                                <span class="badge badge-success badge-sm ml-1">✓</span>
                                            @else
                                                <span class="badge badge-danger badge-sm ml-1">✗</span>
                                            @endif
                                ...
                                <div class="progress mb-2" style="height: 10px;">
                                    <div class="progress-bar bg-primary"
                                        style="width: {{ $informatikaTercapai ? 50 : 0 }}%" data-toggle="tooltip"
                                        title="Informatika: {{ $informatikaTercapai ? 'Tercapai' : 'Belum Tercapai' }}">
                                    </div>
                                    <div class="progress-bar bg-info"
                                        style="width: {{ $sistemInformasiTercapai ? 50 : 0 }}%" data-toggle="tooltip"
                                        title="Sistem Informasi: {{ $sistemInformasiTercapai ? 'Tercapai' : 'Belum Tercapai' }}">
                                    </div>
                                </div>
                                ...
                                <div class="text-xs text-muted">
                                    ...
                                    @if ($keduaProdiTercapai)
                                        <span class="text-success font-weight-bold">Tercapai - Kedua prodi memiliki ≥ 1
                                            HKI</span>
                                    @else
                                        <span class="text-warning font-weight-bold">
                                            Belum Tercapai -
                                            @if (!$informatikaTercapai && !$sistemInformasiTercapai)
                                                Kedua prodi belum memiliki HKI
                                            @elseif (!$informatikaTercapai)
                                                Prodi Informatika belum memiliki HKI
                                            @else
                                                Prodi Sistem Informasi belum memiliki HKI
                                            @endif
                                        </span>
                                    @endif
                                </div>
